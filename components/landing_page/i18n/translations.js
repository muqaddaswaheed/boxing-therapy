...
export const TRANSLATIONS = {
  ...
  fr: {
    booking: {
      ...
      errFields: "Merci de remplir prénom, nom et téléphone pour chaque participant.",
    ...
    admin: {
      ...
      clientEmail: "Email du client (facultatif)",
      generate: "Générer",
  ...
  en: {
    booking: {
      ...
      errFields: "Please fill first name, last name and phone for each participant.",
  ...
  de: {
    booking: {
      ...
      errFields: "Bitte Vorname, Nachname und Telefon für jeden Teilnehmer ausfüllen.",
    ...
    admin: {
      ...
      clientEmail: "E-Mail des Kunden (optional)",
      generate: "Generieren",
